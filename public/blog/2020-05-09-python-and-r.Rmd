...
```
The output only gave me the digits. This is because backslad followed by "d" grabs digits while the + ensures your grabbing all the digits. I know this might appear to be simple but it actually was confusing when I first tested it out. Why not keep going? 
...
I hope that this helped you see some of fun things you can do in python that are somewhat similar actions you can use in R. Remember that you can do anything you set your mind to even if it appears intimidating! Have a great rest of your day and remeber to get fresh air!![](/blog/2020-05-09-python-and-r_files/IMG_2694.JPG)
